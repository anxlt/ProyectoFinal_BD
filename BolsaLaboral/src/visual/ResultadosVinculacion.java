					 ...
					 public void actionPerformed(ActionEvent e) {
						 if(seleccionado.getOferta().getVacantes() > 0) {
							 if(BolsaLaboral.getInstancia().vincularOferta(seleccionado)) {
								 JOptionPane.showMessageDialog(null,"Se ha creado la solicitud correctamente a la oferta " + seleccionado.getOferta().getPuesto() + ".","Informaci�n",JOptionPane.INFORMATION_MESSAGE);
							 } else {
